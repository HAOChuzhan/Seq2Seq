...
from seq2seqModel import Decoder,Encoder,Attention,Seq2Seq


def setup_train_args():
    p = argparse.ArgumentParser(description='Hyperparams')
    p.add_argument('-epoch', type=int, default=30, help='number of epochs for train')
    p.add_argument('-batch_size', type=int, default=32, help='the size of a batch')
    ...
    p.add_argument('-hidden_size', type=int, default=512, help='hidden_size')
    p.add_argument('-embed_size', type=int, default=256, help='embed_size')
    return p.parse_args()
